...
<a class="paging_a paging_bg"  href=authentication.jsp?page=<%=bpage-1%>>
<div class="triangle_left"></div></a></li>
<li class="paging_lists">
<a class="paging_a paging_a_selected" href=authentication.jsp?page=<%=bpage%>><%=bpage %></a></li>
<li class="paging_lists"><a class="paging_a paging_bg"  href=authentication.jsp?page=<%=bpage+1%>>
