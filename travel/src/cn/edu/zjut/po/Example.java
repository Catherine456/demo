...
public class Example {
    ...
    public Example(Integer exampleId, String name, String description, String style, Integer praise, Timestamp time, String area, Integer visits, Designer designer, Set panoramas, Set pictures, Set comments, Set<Employer> em_collecters) {
