...
public class Designer {
    ...
    public Designer(String designerId, String account, String name, String password, String IDNumber, String phone, String email, Boolean sex, String region, String wechat, String qq, Integer score, String profilePhoto, String hmpgbkg, String introduction, Integer fans, Integer praise, Set examples_own, Set examples_star, Set designer_follow, Set orderrs, Set<Needs> needs, String certificate, Set subscribe, String status, String profound, String introduce, String prize, String message, Integer status1, Integer money1, Integer visits, String title) {
        this.setDesignerId(designerId);
