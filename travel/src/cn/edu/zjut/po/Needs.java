...
public class Needs {
    ...
    public Needs(Integer needsId, String title, String description, String style, Timestamp time1, Date time2, Date time3, Float money, Integer enrollment, Employer employer, Set designers, String city, int area) {
