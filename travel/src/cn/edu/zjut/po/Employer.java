...
public class Employer {
    ...
    public Employer(String employerId, String account, String name, String password, String IDNumber, String phone, String email, Boolean sex, String region, String wechat, String qq, String profilePhoto, String hmpgbkg, Set needs, Set examples_star, Set designer_follow, Set orderrs, Set subscribe) {
        this.setEmployerId(employerId);
